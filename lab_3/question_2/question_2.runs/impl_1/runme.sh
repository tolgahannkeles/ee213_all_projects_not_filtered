...
HD_PWD='C:/Users/tolga/Desktop/Projects/vivado/lab_3/question_2/question_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log question_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source question_2.tcl -notrace
