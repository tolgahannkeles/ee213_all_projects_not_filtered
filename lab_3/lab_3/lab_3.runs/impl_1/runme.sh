...
HD_PWD='C:/Users/tolga/Desktop/Projects/vivado/lab_3/lab_3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log question_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source question_1.tcl -notrace
