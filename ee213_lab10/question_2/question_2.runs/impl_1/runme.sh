...
HD_PWD='C:/Users/tolga/Desktop/ee213_lab10/question_2/question_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log question2_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source question2_design_wrapper.tcl -notrace
