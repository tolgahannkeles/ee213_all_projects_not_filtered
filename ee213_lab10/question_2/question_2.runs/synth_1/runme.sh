...
HD_PWD='C:/Users/tolga/Desktop/ee213_lab10/question_2/question_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log question2_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source question2_design_wrapper.tcl
