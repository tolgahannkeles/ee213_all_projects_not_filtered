...
HD_PWD='C:/Users/tolga/Desktop/ee213_lab10/question_1/question_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log question1_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source question1_design_wrapper.tcl
