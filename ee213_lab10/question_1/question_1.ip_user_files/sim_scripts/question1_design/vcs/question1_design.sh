...
design_libs=(xlconcat_v2_1_4 xil_defaultlib xlconstant_v1_1_7)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.question1_design xil_defaultlib.glbl -o question1_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./question1_design_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key question1_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc question1_design_simv.daidir vcs_lib c.obj)
