...
#
# Script generated by Vivado on Wed Jan 03 23:36:22 +0300 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : question1_design.sh
...
#
# Usage        : question1_design.sh
#                question1_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                question1_design.sh [-reset_run]
#                question1_design.sh [-reset_log]
#                question1_design.sh [-help]
#
...
#                script (type 'question1_design.sh -help' for more information).
#
...
design_libs_elab="-libname xlconcat_v2_1_4 -libname xil_defaultlib -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlconcat_v2_1_4 xil_defaultlib xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "question1_design.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./question1_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xlconcat_v2_1_4 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.question1_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.question1_design -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log question1_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./question1_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: question1_design.sh [-help]\n\
Usage: question1_design.sh [-step]\n\
Usage: question1_design.sh [-lib_map_path]\n\
Usage: question1_design.sh [-reset_run]\n\
Usage: question1_design.sh [-reset_log]\n\
Usage: question1_design.sh [-keep_index]\n\
Usage: question1_design.sh [-noclean_files]\n\n\
