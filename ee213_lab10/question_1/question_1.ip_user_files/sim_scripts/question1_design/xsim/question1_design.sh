...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xlconcat_v2_1_4 -L xil_defaultlib -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot question1_design xil_defaultlib.question1_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim question1_design -key {Behavioral:sim_1:Functional:question1_design} -tclbatch cmd.tcl -protoinst "protoinst_files/question1_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb question1_design.wdb xsim.dir libdpi.so)
