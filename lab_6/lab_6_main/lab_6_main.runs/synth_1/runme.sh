...
HD_PWD='C:/Users/tolga/Desktop/Projects/vivado/lab_6/lab_6_main/lab_6_main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log root_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source root_1_wrapper.tcl
