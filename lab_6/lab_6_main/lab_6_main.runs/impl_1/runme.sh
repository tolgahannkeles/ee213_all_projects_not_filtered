...
HD_PWD='C:/Users/tolga/Desktop/Projects/vivado/lab_6/lab_6_main/lab_6_main.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log root_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source root_1_wrapper.tcl -notrace
