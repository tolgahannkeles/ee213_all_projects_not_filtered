...
HD_PWD='C:/Users/tolga/Desktop/Projects/vivado/lab_6/lab_6_ip/lab_6_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_1_wrapper.tcl
