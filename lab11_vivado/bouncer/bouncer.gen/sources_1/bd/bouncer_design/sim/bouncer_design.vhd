...
architecture STRUCTURE of bouncer_design is
  ...
  component bouncer_design_xup_dff_en_0_0 is
  port (
    d : in STD_LOGIC;
    clk : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component bouncer_design_xup_dff_en_0_0;
  component bouncer_design_xup_dff_en_0_1 is
  port (
    d : in STD_LOGIC;
    clk : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component bouncer_design_xup_dff_en_0_1;
...
begin
  ...
  X_1 <= X;
  en_1 <= en;
xup_dff_en_0: component bouncer_design_xup_dff_en_0_0
     port map (
      clk => SCLK_1,
      d => xup_xor2_0_y,
      en => en_1,
...
xup_dff_en_1: component bouncer_design_xup_dff_en_0_1
     port map (
      clk => FCLK_1,
      d => xup_dff_en_0_q,
      en => en_1,
