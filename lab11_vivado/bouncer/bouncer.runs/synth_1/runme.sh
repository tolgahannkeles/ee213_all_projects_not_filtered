...
HD_PWD='C:/Users/tolga/Desktop/lab11_vivado/bouncer/bouncer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncer_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bouncer_design_wrapper.tcl
