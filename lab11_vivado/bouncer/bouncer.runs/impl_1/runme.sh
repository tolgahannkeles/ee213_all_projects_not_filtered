...
HD_PWD='C:/Users/tolga/Desktop/lab11_vivado/bouncer/bouncer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncer_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bouncer_design_wrapper.tcl -notrace
